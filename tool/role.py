...
PERMISSION_DICT = [
    {"from": "service_project_management", "to": "服务项目管理"},
    {"from": "product_category_management", "to": "商品分类管理"},
    {"from": "equipment_category_management", "to": "设备类别管理"},
]

original_permission = [item["to"] for item in PERMISSION_DICT]
...
@tool
class Role:
    args_schema: Type[BaseModel] = RoleSchema
    end_flag: int = 0
