    ...
    async def agent_execute(
        ...
        try:
            ...
            if "message_history" in signature.parameters or any(
                ...
                tool_arguments["message_history"] = chat_history
            ...
            # if tool_success_counter[tool_name] >= 2:
                ...
                # if the_tool.end_flag == 0:
                    ...
                    # final_messages = [{"role": "observation", "content": final_prompt}]
            ...
            # if tool_error_counter[tool_name] >= 3:
                ...
                #     async for chunk in  self.enhance_llm.llm._whoami_tool(messages=messages, timeout=30):
                #         yield chunk
                #     return
                # else:
                #     # 最终失败
